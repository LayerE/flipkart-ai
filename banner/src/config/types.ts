...
export type RectangleObject = ObjectCommonProperties & {
  type: 'rectangle';
} & Pick<CanvasObject, 'backgroundColorHex' | 'strokeColorHex' | 'strokeWidth' | 'borderRadius'|'rotation'>;
...
export type FreeDrawObject = ObjectCommonProperties & {
  type: 'free-draw';
} & Pick<CanvasObject, 'strokeColorHex' | 'strokeWidth' | 'freeDrawPoints'|'rotation'>;
...
export type ImageObject = ObjectCommonProperties & {
  type: 'image';
} & Pick<CanvasObject, 'imageUrl' | 'imageElement'|'rotation'>;
