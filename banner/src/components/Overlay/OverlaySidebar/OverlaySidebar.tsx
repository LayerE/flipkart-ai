...
import AssetsControl from './controls/AssetsControl'
  ...
  return (
    <Aside>
      <div>
        ...
        {activeNodes.icons && <AssetsControl />}
        ...
        {activeNodes.layer && activeObject?.type=='image' &&<CropControl/>}
        {activeNodes.actions && <ActionsControl />}
        {activeNodes.actions  && activeObject?.type!='free-draw' && <RotateControl />}
      </div>
    </Aside>
  );
}
